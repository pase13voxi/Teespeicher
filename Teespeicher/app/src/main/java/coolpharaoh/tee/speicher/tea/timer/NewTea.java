...
public class NewTea extends AppCompatActivity {
    ...
    private void askPermissions(){
        if (ContextCompat.checkSelfPermission(NewTea.this,
                Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(NewTea.this,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                ...
                ActivityCompat.requestPermissions(NewTea.this,
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(NewTea.this, "Permission denied to read and write your External storage", Toast.LENGTH_SHORT).show();
